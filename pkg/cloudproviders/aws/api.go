...
//go:generate mockgen -destination=./mocks/api_mocks.go gilds-git.signintra.com/aws-dctf/kubernetes/node-undertaker/pkg/cloudproviders/aws EC2CLIENT,ELBCLIENT,ELBV2CLIENT,ASGCLIENT
